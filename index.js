...
function isValue(obj) {
  return ['Null', 'Undefined', 'Arguments', 'Function', 'String', 'Number', 'Date', 'RegExp', 'Error', 'Symbol', 'Map', 'WeakMap', 'Set', 'WeakSet', 'Array'].some(name => toString.call(obj) === `[object ${name}]` )
}
...
module.exports = function traverse(object) {
  ...
  _keys.forEach(key => {
    ...
    if (o && !isValue(o) && Object.keys(o).length > 0) {
